...
const Footer = ({ darkMode, setDarkMode }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[500px] h-40 pointer-events-none"
        style={{
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="flex gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-8 h-8 rounded-md flex items-center justify-center text-gray-500 hover:text-teal-400 transition-colors"
          ...
          >
            <p className="text-xs text-gray-600 uppercase tracking-wider font-semibold mb-5">Navigation</p>
          ...
          >
            <p className="text-xs text-gray-600 uppercase tracking-wider font-semibold mb-5">Preferences</p>
            <button
            ...
            >
              <div
                ...
                style={{ background: darkMode ? '#0d9488' : '#1a1a1a', border: '1px solid rgba(255,255,255,0.1)' }}
              >
                <div
