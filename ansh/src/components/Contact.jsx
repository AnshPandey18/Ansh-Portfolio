              ...
              <div className="space-y-8">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    >
                      <span className={info.primary ? 'text-tealAccent' : 'text-gray400'}>
                        {info.icon}
                      </span>
                      {/* Icon glow */}
                      <motion.div
                    ...
                    <div className="flex-1 relative z-10">
                      <p className="text-sm text-gray400 mb-2 font-semibold uppercase tracking-wider">{info.type}</p>
                ...
                <div className="flex flex-wrap gap-5">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      className="p-6 glass-dark border-2 border-gray700 rounded-2xl hover:border-tealAccent transition-all relative group"
                      whileHover={{
                        scale: 1.2,
                        rotateY: 180,
                        y: -8,
