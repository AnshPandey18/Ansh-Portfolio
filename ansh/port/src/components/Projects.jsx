...
const PROJECTS = [
  {
    ...
    category: 'Full Stack',
    year: '2025',
    tech: ['React', 'Node.js', 'Express.js', 'MySQL', 'Docker', 'Render', 'PayPal API'],
    desc: 'Research management SaaS — save articles, organize PDFs, generate AI summaries. Built 10+ REST API endpoints, optimized MySQL queries reducing latency ~35%, containerized with Docker and deployed on Render.',
    role: 'Full Stack Developer Intern @ IT Fosters',
  ...
  },
  {
    ...
    category: 'Full Stack',
    year: '2025',
    tech: ['React.js', 'Node.js', 'Express.js', 'SQL', 'Docker', 'Vercel', 'Render'],
    desc: 'Full-stack SaaS dashboard for smart subscription management with privacy-first design. Built with SQL for relational data modeling, containerized with Docker, and deployed on Vercel + Render.',
  ...
  },
  {
    ...
    category: 'Full Stack',
    year: '2025',
    tech: ['React.js', 'Node.js', 'Express.js', 'MySQL', 'Docker', 'Render'],
    desc: 'Citizen-government civic engagement platform enabling real-time complaint submission, tracking, and resolution. Dual-portal system with role-based auth, REST APIs with MySQL, and Docker deployment.',
    role: 'Full Stack Developer',
  ...
  },
  {
    ...
    desc: 'Freelancing marketplace with reduced service fees. Features job posting, multi-bid management, and freelancer profiles with end-to-end authentication and database-driven workflows.',
    role: 'Full Stack Developer',
