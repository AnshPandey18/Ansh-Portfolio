    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="grid md:grid-cols-3 gap-16 mb-16">
          ...
          >
            <motion.h3 
              className="text-4xl md:text-5xl font-black mb-6 relative inline-block cursor-pointer"
            ...
            <nav className="flex flex-col space-y-4">
              {navItems.map((item, index) => (
                <motion.a
                  ...
                  className="flex items-center gap-3 text-gray-300 hover:text-tealAccent transition-all group relative"
          ...
          >
            ...
            >
              <span className="text-gray-300 font-bold text-base relative z-10">
                {darkMode ? 'Dark' : 'Light'} Mode
              </span>
              <motion.div
                className="relative w-20 h-10 bg-gray-800 rounded-full border-2 border-gray-700 p-1"
                style={{
        ...
        {/* Copyright */}
        <motion.div
          className="border-t border-gray-700/50 pt-12 flex flex-col md:flex-row justify-between items-center gap-6"
        ...
        >
          ...
          <motion.p
            className="text-gray-400 text-sm flex items-center gap-3 font-medium"
            whileHover={{ scale: 1.05 }}
          >
