...
const Contact = () => {
  ...
  const inputStyle = (id) => ({
    width: '100%',
    padding: '12px 16px',
    background: focused === id ? 'rgba(212,168,67,0.04)' : 'var(--surface2)',
    border: `1px solid ${focused === id ? 'rgba(212,168,67,0.4)' : 'var(--border)'}`,
    borderRadius: 12,
    color: 'var(--text-1)',
    fontSize: '0.875rem',
    outline: 'none',
  ...
  return (
    <section id="contact" className="py-32 md:py-40 relative overflow-hidden" style={{ background: 'var(--surface)' }}>
      <div
      ...
      <div ref={ref} className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <span className="pill mb-4 inline-flex">Contact</span>
          <h2
        ...
        <div className="grid md:grid-cols-5 gap-12 md:gap-16">
          ...
          >
            {submitted && (
              <div
                className="p-4 rounded-xl text-sm font-medium mb-2"
                style={{ background: 'rgba(212,168,67,0.1)', border: '1px solid rgba(212,168,67,0.25)', color: 'var(--gold)' }}
              >
            ...
            {[
              { id: 'name', label: 'Full Name', type: 'text', placeholder: 'Ansh Pandey' },
            ...
            <motion.button
              ...
              className="w-full py-3.5 text-sm font-bold rounded-xl flex items-center justify-center gap-2"
          ...
          >
            ...
            >
              ...
              <p className="text-xs" style={{ color: 'var(--text-3)' }}>
                Currently open to freelance and internship opportunities.
              </p>
            </div>
          </motion.div>
        </div>
